package net.ncplanner.plannerator.simplelibrary.config2;
    ...
    protected ConfigBase newConfig(int index){
        switch(index){
            ...
            case 8://Old ConfigHugeLong type, removed
                throw new IllegalArgumentException("The HugeLong type was removed!  Use SimpleLibrary version 10.2.1 or earlier to read this file.");
            case 9:
